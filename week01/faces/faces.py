...
# input and returns that same input with any :) converted to 🙂 (otherwise known as a slightly 
# smiling face) and any :( converted to 🙁 (otherwise known as a slightly frowning face). All other 
